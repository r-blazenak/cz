...
<head>
    ...
    <link rel="stylesheet" href=<?php echo URLROOT."public/css/test.css";?>>
...
<body>
    ...
    <script>
        window.onload = () => {
            console.log(document.querySelector("#emp-table > tbody > tr:nth-child(1) > td:nth-child(2) "));
            console.log(document.querySelector("#emp-table > tbody > tr:nth-child(3) > td:nth-child(3) ").innerHTML);
        };
    ...
    let isPositiv2 = number => number >= 0;
