...
class Database_db_cut1 {

    // data ze souboru app/config/config
    private $host = DB_HOST_CUT;
    private $uzivatel = DB_USER_CUT1;
    private $heslo = DB_PASS_CUT1;
    private $databaze;
    private  $port;
    ...
    public function __construct($databaze, $port){
        ...
        $this->port = $port;
        $dsn = 'pgsql:host=' . $this->host . ';dbname=' . $this->databaze . ';port=' . $this->port;
        $options = array (
